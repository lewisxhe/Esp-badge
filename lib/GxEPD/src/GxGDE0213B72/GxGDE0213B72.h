...
#ifndef _GxGDE0213B72_H_
#define _GxGDE0213B72_H_

#include "../GxEPD.h"

// the physical number of pixels (for controller parameter)
#define GxGDE0213B72_X_PIXELS 128
#define GxGDE0213B72_Y_PIXELS 250

// the logical width and height of the display
#define GxGDE0213B72_WIDTH GxGDE0213B72_X_PIXELS
#define GxGDE0213B72_HEIGHT GxGDE0213B72_Y_PIXELS

// note: the visible number of display pixels is 122*250, see GDEH0213B1 V3.0 Specification.pdf
#define GxGDE0213B72_VISIBLE_WIDTH 122

#define GxGDE0213B72_BUFFER_SIZE (uint32_t(GxGDE0213B72_WIDTH) * uint32_t(GxGDE0213B72_HEIGHT) / 8)

// divisor for AVR, should be factor of GxGDE0213B72_HEIGHT
#define GxGDE0213B72_PAGES 5

#define GxGDE0213B72_PAGE_HEIGHT (GxGDE0213B72_HEIGHT / GxGDE0213B72_PAGES)
#define GxGDE0213B72_PAGE_SIZE (GxGDE0213B72_BUFFER_SIZE / GxGDE0213B72_PAGES)

class GxGDE0213B72 : public GxEPD
{
  public:
#if defined(ESP8266)
    //GxGDE0213B72(GxIO& io, int8_t rst = D4, int8_t busy = D2);
    // use pin numbers, other ESP8266 than Wemos may not use Dx names
    GxGDE0213B72(GxIO& io, int8_t rst = 2, int8_t busy = 4);
#else
    GxGDE0213B72(GxIO& io, int8_t rst = 9, int8_t busy = 7);
#endif
    ...
    void powerDown();
    // paged drawing, for limited RAM, drawCallback() is called GxGDE0213B72_PAGES times
  ...
  protected:
#if defined(__AVR)
    uint8_t _buffer[GxGDE0213B72_PAGE_SIZE];
#else
    uint8_t _buffer[GxGDE0213B72_BUFFER_SIZE];
#endif
  private:
    GxIO& IO;
...
#ifndef GxEPD_Class
#define GxEPD_Class GxGDE0213B72
#define GxEPD_WIDTH GxGDE0213B72_WIDTH
#define GxEPD_HEIGHT GxGDE0213B72_HEIGHT
#define GxEPD_BitmapExamples <GxGDE0213B72/BitmapExamples.h>
#define GxEPD_BitmapExamplesQ "GxGDE0213B72/BitmapExamples.h"
#endif
