...
class GxDEPG0213BN : public GxEPD
{
public:
#if defined(ESP8266)
    //GxDEPG0213BN(GxIO& io, int8_t rst = D4, int8_t busy = D2);
    ...
    void powerDown();
    // paged drawing, for limited RAM, drawCallback() is called GxDEPG0213BN_PAGES times
...
protected:
#if defined(__AVR)
    uint8_t _buffer[GxDEPG0213BN_PAGE_SIZE];
#else
    uint8_t _buffer[GxDEPG0213BN_BUFFER_SIZE];
#endif
private:
    GxIO &IO;
...
#ifndef GxEPD_Class
#define GxEPD_Class GxDEPG0213BN
#define GxEPD_WIDTH GxDEPG0213BN_WIDTH
#define GxEPD_HEIGHT GxDEPG0213BN_HEIGHT
#define GxEPD_BitmapExamples <GxDEPG0213BN/BitmapExamples.h>
#define GxEPD_BitmapExamplesQ "GxDEPG0213BN/BitmapExamples.h"
#endif
